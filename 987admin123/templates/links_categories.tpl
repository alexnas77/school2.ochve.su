    ...
    <TD ALIGN=LEFT VALIGN=TOP CLASS=body>
      <TABLE CELLPADDING=0 CELLSPACING=0 WIDTH=100%>
        <TR>
          ...
          <TD ALIGN=RIGHT>
            <a href='index.php?section=EditLinksCategories&parent={$Parent->category_id}'>{$Lang->NEW_CATEGORY}</a>
          </TD>
        </TR>
      </TABLE>
    </TD>
...
<TABLE WIDTH=100% CLASS=list CELLPADDING=4 CELLSPACING=1>
  ...
  {include file=lcat.tpl Categories=$Categories level=0}
</TABLE>
