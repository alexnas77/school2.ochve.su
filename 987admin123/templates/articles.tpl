...
<TABLE WIDTH=100% BORDER=0 CELLPADDING=5 CELLSPACING=0>
  <TR>
    <TD ALIGN=LEFT VALIGN=TOP CLASS=subheader colspan=3>
      <a href='index.php'>{$Settings->site_name}</a> / {$Lang->ARTICLES}
    </TD>
  </TR>
  <TR>
    <TD ALIGN=LEFT VALIGN=TOP CLASS=header>
       <img src='images/articles_icon.png' border=0 align=absmiddle> {$Lang->ARTICLES}
    </TD>
  </TR>
  <TR>
    <TD HEIGHT=10>
    ...
    <TD ALIGN=LEFT VALIGN=TOP CLASS=body>
      <TABLE CELLPADDING=0 CELLSPACING=0 WIDTH=100%>
        <TR>
          ...
          <TD ALIGN=RIGHT>
            <a href='index.php?section=EditArticle'>{$Lang->NEW_ARTICLE}</a>
          </TD>
        </TR>
      </TABLE>
    </TD>
  ...
  <TR>
    ...
    <TD class=list align=center>
     ...
     <TD class=list align=center>
       ...
       <input name="ids[{$item->article_id}]" type="hidden" value="{$item->article_id}">
    </TD>
    <TD class=list align=center>
